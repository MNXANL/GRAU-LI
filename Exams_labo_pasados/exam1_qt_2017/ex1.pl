...
% EXAM START: The former T is now an incognito value. 
% I left it as such so I don't have to worry about modifying the other parts.
workingHourForTypeAndStartH(_,StartH,H):- 
    between(0,1,I), 
    H is (StartH+I) mod 24.
workingHourForTypeAndStartH(_,StartH,H):- 
    between(3,4,I), 
